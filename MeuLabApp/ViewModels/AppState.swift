        ...
        async throws -> WeatherData
    {
        ...
        return WeatherData(
            ...
            current: CurrentWeather(
                tempC: data.current.tempC != 0 ? data.current.tempC : enriched.current.tempC,
                feelsLikeC: data.current.feelsLikeC != 0 ? data.current.feelsLikeC : enriched.current.feelsLikeC,
                humidity: data.current.humidity != 0 ? data.current.humidity : enriched.current.humidity,
                windKmh: data.current.windKmh != 0 ? data.current.windKmh : enriched.current.windKmh,
                windDir: data.current.windDir.isEmpty ? enriched.current.windDir : data.current.windDir,
                description: data.current.description.isEmpty ? enriched.current.description : data.current.description,
                precipMm: data.current.precipMm,
                uvIndex: data.current.uvIndex != 0 ? data.current.uvIndex : enriched.current.uvIndex,
